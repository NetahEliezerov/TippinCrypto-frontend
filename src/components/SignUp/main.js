                ...
                <h1 className="text-green-400 text-4xl pt-24" style={{fontFamily:'Poppins', fontWeight: '800'}}>
                    <Gradient dir="left-to-right" from="#9C4EFF" to="#FF006B">
                        ...
                        { <Gradient dir="left-to-right" from="#149911" to="#1EFC1E">
                           ...
                           <br />
                            { <Gradient dir="left-to-right" from="#149911" to="#1EFC1E">
                                <a href={`${currentHostName}/${publicKey}/alert`} className="text-2xl">{`${currentHostName}/${publicKey}/alert`}</a>
                                </Gradient> }
                            <br /><br />
                            Tipping Page Link
                            <br />
                            { <Gradient dir="left-to-right" from="#149911" to="#1EFC1E">
                                <a href={`${currentHostName}/${publicKey}/${streamingSig}/${streamerName}`} className="text-2xl" style={{textDecoration: 'underline'}}>{putDotsAfterLongString(`${currentHostName}/${publicKey}/${streamingSig}/${streamerName}`)}</a>
                                </Gradient> }
                            </Gradient>
                            </h1>
