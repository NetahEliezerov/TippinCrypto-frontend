        ...
        <div>
            <div className="p-72">
                ...
                { checkifConnectedState ?
                    <div><button onClick={() => window.location.href = "/signup?as=streamer"} className="bg-green-400 hover:bg-white hover:text-green-400 text-gray-900 font-bold py-3 px-6 rounded transition-all duration-200 mt-10" style={{fontFamily:'Poppins',fontWeight:'400',fontSize:'16px'}}>I'm a Streamer</button><br />
