    ...
    return (
        <div>
            <div className="p-72 mainHomeElements">
                <h1 className="text-5xl text-blue-500 mainTextHome z-10">Grow your channel revenue<br /><span className="text-white"><Gradient dir="left-to-right" from="#9C4EFF" to="#FF006B">with our Crypto tipping solution.</Gradient></span></h1>
